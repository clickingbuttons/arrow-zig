...
pub const ImportedArray = struct {
    ...
    fn importBufs(arr: abi.Array, tag: tags.Tag, arr_len: usize) !Array.Buffers {
        ...
        const actual_buffers: usize = @bitCast(arr.n_buffers);
    ...
    fn initArray(allocator: Allocator, arr: abi.Array, schema: abi.Schema) !*Array {
        ...
        res.* = .{
            ...
            .allocator = allocator,
            .length = arr_len,
            .null_count = @bitCast(arr.null_count),
            .buffers = buffers,
            .children = children,
        };
