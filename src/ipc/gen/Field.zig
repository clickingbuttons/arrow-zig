...
//! `print`, `toTag`, `toMaybeDictTag`, `nBuffers`, and `initFromArray` added manually
...
pub const Field = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, packed_: PackedField) flatbuffers.Error!Self {
        ...
        const dictionary = if (try packed_.dictionary()) |d| try types.DictionaryEncoding.init(d) else null;
    ...
    pub fn toMaybeDictTag(self: Self) IpcError!Tag {
